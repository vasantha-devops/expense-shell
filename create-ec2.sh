...
for name in ${instances[@]}; do
    ...
    instance_id=$(aws ec2 run-instances --image-id i-05905ea3bc692ad89 --instance-type $instance_type --security-group-ids sg-0fea5e49e962e81c9 --subnet-id subnet-09863c54177764565 --query 'Instances[0].InstanceId' --output text)
